        ...
        <div className="flex flex-col gap-6 max-w-3xl">
          ...
          {!reduced ? (
            <motion.h1
              ...
              className="font-display font-medium text-[clamp(1.6rem,5.5vw,4.5rem)] leading-[1.05] tracking-[-0.03em] whitespace-nowrap text-foreground [text-shadow:0_2px_20px_rgba(0,0,0,0.7)]"
            >
              {hero.headline}
            </motion.h1>
          ) : (
            <h1 className="font-display font-medium text-[clamp(1.6rem,5.5vw,4.5rem)] leading-[1.05] tracking-[-0.03em] whitespace-nowrap text-foreground [text-shadow:0_2px_20px_rgba(0,0,0,0.7)]">
              {hero.headline}
            </h1>
          )}
