...
export const BLOCK_KEYS = ['home_hero', 'home_callouts', 'about_body', 'careers_body', 'site_banner'] as const;
...
export const contentBlocks = pgTable(
  ...
  (t) => [
    check(
      ...
      sql`${t.key} IN ('home_hero', 'home_callouts', 'about_body', 'careers_body', 'site_banner')`,
    ),
  ],
);
